...
# kinetics method
from gym_carla.util_development.kinetics import angle_reg

# todo inherit from carla module
...
from gym_carla.modules.rl_modules.state_representation.state_manager_3 import (
