...
class TrafficFlowManager5(TrafficFlowManager4):
    ...
    traffic_flow_info = {
        'positive_x': {
            ...
            'distance_range': (16, 50),  # in meters
            'distance_threshold': 16,

            'target_speed_range': (10, 40),  # in km/h
            'target_speed': 40,
        },
    ...
    def clear_traffic_flow_info(self):
        """
        Clear traffic flow info dict of the class attribute.
        """

        for key in self.traffic_flow_info:

            info_dict = self.traffic_flow_info[key]

            info_dict['vehicle_list'] = []
            info_dict['sensor_api_dict'] = {}
            info_dict['sensor_dict'] = {}
            info_dict['local_planner_dict'] = {}
            info_dict['collision_flag_dict'] = {}

        # this is the additional class attribute for tf management
        self.block_time_dict = {}

        print('Info dict is fully cleared.')
