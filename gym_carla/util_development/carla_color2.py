"""
This is supposed to be a more advanced tool to retrieve carla color

More color options and some useful tools.
"""

import carla


LightPink = carla.Color(255,182,193)  # 浅粉红
Pink = carla.Color(255,192,203)  # 粉红
Crimson = carla.Color(220,20,60)  # 猩红
LavenderBlush = carla.Color(255,240,245)  # 脸红的淡紫色
PaleVioletRed = carla.Color(219,112,147)  # 苍白的紫罗兰红色
HotPink = carla.Color(255,105,180)  # 热情的粉红

DeepPink = carla.Color(255,20,147)  # 深粉色
MediumVioletRed = carla.Color(199,21,133)  # 适中的紫罗兰红色
Orchid = carla.Color(218,112,214)  # 兰花的紫色
Thistle = carla.Color(216,191,216)  # 蓟
Plum = carla.Color(221,160,221)  # 李子
Violet = carla.Color(238,130,238)  # 紫罗兰
Magenta = carla.Color(255,0,255)  # 洋红
Fuchsia = carla.Color(255,0,255)  # 灯笼海棠(紫红色)
DarkMagenta = carla.Color(139,0,139)  # 深洋红色
Purple = carla.Color(128,0,128)  # 紫色
