...
Major modifications:
 ...
 - Add args and methods for traffic flow params decay, such as collision rate and parameters' range
...
class CarlaEnv4Fixed(CarlaEnv4):
    ...
    def __init__(
        ...
        if self.multi_task:
            ...
            elif self.route_option == 'straight':  # go straight on left turn lane
                tf_direction = ['negative_y_0', 'negative_x']
            else:
