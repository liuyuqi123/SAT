...
class CarlaEnv4(CarlaEnv3):
    ...
    def init_traffic_flow(self):
        ...
        min_npc_number = 5 if self.multi_task else 2
    ...
    def tick_controller(self, action):
        ...
        # fixme put this line into tick loop??
    ...
    def step(self, action: tuple):
        ...
        for i in range(self.down_sample_factor):  # down_sample_factor is renamed as frame skipping
