...
def run(result_folder, title=None):
    ...
    for item in category_list:
        ...
        # chinese category as labels
        if item == 'Multi-task(baseline)':
            chn_label = '多任务基线'
        elif item == 'Multi-task+Attention':
            chn_label = '多任务+注意力'
        elif item == 'Multi-task+Attention+Safety':
            chn_label = '多任务+注意力+安全层'
        elif item == 'Multi-task+Safety':
            chn_label = '多任务+安全层'
        elif item == 'TD3(baseline)':
            chn_label = '单任务基线'
        elif item == 'TD3+Attention':
            chn_label = 'TD3+注意力'
        elif item == 'TD3+Attention+Safety':
            chn_label = 'TD3+注意力+安全层'
        elif item == 'TD3+Safety':
            chn_label = 'TD3+安全层'
        else:
